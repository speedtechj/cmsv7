...
use App\Filament\Appuser\Resources\CatextrachargeResource\Pages;
use App\Filament\Appuser\Resources\CatextrachargeResource\RelationManagers;
...
class CatextrachargeResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Charges Category';
    public static ?string $label = 'Charges Category';
